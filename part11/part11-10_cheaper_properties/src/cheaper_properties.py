...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(i, i.price_difference(reference)) for i in properties if i.price_difference(reference) > 0 and not i.more_expensive(reference)]
...
if __name__ == "__main__":
    ...
    # for i in cheaper_properties(properties, a3):
    #     print(i)
